...
public class MainActivity extends AppCompatActivity {
    ...
    private String vue1 = "";
    private boolean r = false;//booléen qui vaut vrai si on a déterminé le résultat d'un calcul
    ...
    public void lockDeviceRotation(boolean value) {//bloquer la rotation de l'écran, laisser sur portrait
        if (value) {
    ...
    public void remplaceVirgule(){//remplace une virgule par un point
    ...
    public void remplacePoint(){//remplace un point par une virgule
        StringBuilder chaine = new StringBuilder();
